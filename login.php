...
if (!$authenticated) {
  $_SESSION['CAS'] = true;
  header("Location: https://cas.iu.edu/cas/login?cassvc=appCode&casurl=https://cgi.soic.indiana.edu/~smkramer/i491/smkramer/index.php");
  exit;
}
...
if ($authenticated) {
  ...
  if (isset($_GET["casticket"])) {
	...
	$casurl = 'https://cgi.soic.indiana.edu/~smkramer/i491/smkramer/index.php'; //same base URLsent
